...
const initialMembers: Member[] = [
  { initials: "AC", name: "Ana Clara Oliveira", email: "ana.clara@email.com", ministry: "Louvor", ministryColor: "blue", status: "Ativo", baptism: "Batizado", date: "15 Mai, 2021" },
  { initials: "MS", name: "Marcos Santos", email: "marcos.santos@email.com", ministry: "Missões", ministryColor: "green", status: "Ativo", baptism: "Batizado", date: "10 Jan, 2020" },
  { initials: "JP", name: "Julia Pereira", email: "julia.p@email.com", ministry: "Nenhum", ministryColor: "gray", status: "Inativo", baptism: "Aguardando", date: "22 Ago, 2023" },
  { initials: "RM", name: "Ricardo Mendes", email: "mendes.r@email.com", ministry: "Acolhimento", ministryColor: "purple", status: "Ativo", baptism: "Batizado", date: "05 Abr, 2019" },
  { initials: "BL", name: "Beatriz Lima", email: "bia.lima@email.com", ministry: "Infantil", ministryColor: "purple", status: "Ativo", baptism: "Batizado", date: "18 Fev, 2022", isNew: true },
  { initials: "GS", name: "Gabriel Souza", email: "gabriel.s@email.com", ministry: "Louvor", ministryColor: "blue", status: "Ativo", baptism: "Aguardando", date: "03 Mar, 2024", isNew: true },
  { initials: "CM", name: "Carla Martins", email: "carla.m@email.com", ministry: "Missões", ministryColor: "green", status: "Ativo", baptism: "Batizado", date: "11 Set, 2018" },
  { initials: "PH", name: "Paulo Henrique", email: "paulo.h@email.com", ministry: "Acolhimento", ministryColor: "purple", status: "Inativo", baptism: "Batizado", date: "29 Jun, 2017" },
  { initials: "LF", name: "Larissa Freitas", email: "larissa.f@email.com", ministry: "Infantil", ministryColor: "purple", status: "Ativo", baptism: "Aguardando", date: "07 Mai, 2024", isNew: true },
  { initials: "DR", name: "Daniel Rocha", email: "daniel.r@email.com", ministry: "Louvor", ministryColor: "blue", status: "Ativo", baptism: "Batizado", date: "14 Nov, 2020" },
  { initials: "MT", name: "Mariana Teixeira", email: "mariana.t@email.com", ministry: "Nenhum", ministryColor: "gray", status: "Ativo", baptism: "Aguardando", date: "23 Abr, 2024", isNew: true },
  { initials: "FC", name: "Felipe Costa", email: "felipe.c@email.com", ministry: "Missões", ministryColor: "green", status: "Inativo", baptism: "Batizado", date: "17 Jul, 2016" },
  { initials: "ES", name: "Eduarda Silva", email: "eduarda.s@email.com", ministry: "Acolhimento", ministryColor: "purple", status: "Ativo", baptism: "Batizado", date: "09 Out, 2021" },
  { initials: "RA", name: "Rafael Alves", email: "rafael.a@email.com", ministry: "Louvor", ministryColor: "blue", status: "Ativo", baptism: "Aguardando", date: "28 Mai, 2024", isNew: true },
  { initials: "NC", name: "Natália Cardoso", email: "natalia.c@email.com", ministry: "Infantil", ministryColor: "purple", status: "Ativo", baptism: "Batizado", date: "12 Dez, 2019" },
  { initials: "VC", name: "Vinícius Carvalho", email: "vinicius.c@email.com", ministry: "Nenhum", ministryColor: "gray", status: "Inativo", baptism: "Aguardando", date: "06 Jan, 2023" },
  { initials: "IS", name: "Isabela Santos", email: "isabela.s@email.com", ministry: "Missões", ministryColor: "green", status: "Ativo", baptism: "Batizado", date: "19 Ago, 2022" },
  { initials: "HO", name: "Henrique Oliveira", email: "henrique.o@email.com", ministry: "Acolhimento", ministryColor: "purple", status: "Ativo", baptism: "Aguardando", date: "02 Mai, 2024", isNew: true },
];
            ...
            <div className="members-table-scroll">
              <table className="members-table">
                ...
                <tbody>
                  ...
                  {!visibleMembers.length && <tr><td className="members-empty" colSpan={6}>Nenhum membro encontrado com esses filtros.</td></tr>}
                </tbody>
              </table>
            </div>
